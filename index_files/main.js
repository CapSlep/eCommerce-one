...
const mainInit = () => {
  ...
  // ================ Block of code for product selection! ===================
  ...
  // ================ END Block of code for product selection! ===================
...
window.onload = () => {
  ...
  if (finalForm) {
    finalForm.addEventListener('submit', function (e) {
      ...
      let adRedirectName = `${mainProduct.name} ${pr.name} ${cart.main.size}: ${lsGetSelectedSize()}`;
      let adRedirectImg = document.querySelector("input[name='product_image']").value;
      console.log(adRedirectImg);
      // Get country code
